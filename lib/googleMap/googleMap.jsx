...
class GoogleMap extends React.Component {
    ...
    render() {
        const { mapElementId, searchElementId, onSearchBoxMounted, searchPlaceholder, searchOptions, inputStyle, suggestionStyle, } = this.props;
        const { scriptLoaded } = this.state;
        return (<div style={ctr}>
                <div style={mapCtr} id={mapElementId}/>
                {scriptLoaded && searchElementId ? (<SearchBox ref={ref => (this.searchInput = ref)} placeholder={searchPlaceholder} searchOptions={searchOptions} elementId={searchElementId} onMount={onSearchBoxMounted} onPlacesChanged={this.onPlacesChanged} inputStyle={inputStyle} suggestionStyle={suggestionStyle}/>) : null}
            </div>);
    }
}
