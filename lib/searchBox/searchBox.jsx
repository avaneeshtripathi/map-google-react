...
class SearchBox extends React.Component {
    constructor() {
        ...
        this.onSuggestionClick = (suggestion) => () => this.handleSelect(suggestion);
    ...
    render() {
        const { elementId, placeholder, inputStyle = {}, suggestionStyle = {}, } = this.props;
        const { suggestions, inputValue } = this.state;
        return (<div style={searchBoxCtr}>
                <input autoComplete="off" id={elementId} placeholder={placeholder || 'Search location'} style={{ ...searchInput, ...inputStyle }} value={inputValue} onChange={this.handleSearch} onKeyDown={this.handleInputKeyDown} onFocus={this.handleSearch} type="text"/>
